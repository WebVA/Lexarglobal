        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Add Testimonials</h6>
    ...
    <div class="margin-row">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                    <button type="button" class="btn btn-default" style="float:right;" onclick="add_testimonials()">Save Testimonials</button>
                    </div>
                </div>
            </div>
        </div>
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You added a new testimonials!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to add a new testimonials!</span>
    ...
    <script type="text/javascript">
        function add_testimonials(){
            if($("#title").val() && $("#description").val()){
                $.ajax({ 
                    method:'POST',
                    url:'/websetting/add_testimonials',
                    data:{
                        title:$("#title").val(),
                        status:$("#status").val(),
