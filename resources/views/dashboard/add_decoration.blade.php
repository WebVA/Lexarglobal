        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Add Decoration</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links">
                  <li class="breadcrumb-item"><a href="/dashboard"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="/decoration/decoration">Manage Decoration</a></li>
    ...
    <div class="margin-row">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="decoration_id" readonly placeholder="Can't input id">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-control-label" for="decoration_name">Decoration Name</label>
                            <input type="text" class="form-control" id="decoration_name" placeholder="Enter decoration Name">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form>
                          <div class="form-group">
                            <textarea class="form-control" id="decoration_description" rows="3"></textarea>
                          </div>
                        </form>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                    <button type="button" class="btn btn-default" style="float:right;" onclick="add_decoration()">Save Decoration</button>
                    </div>
                </div>
            </div>
        </div>
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You added a new decoration!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to add a new decoration!</span>
  ...
  <script type="text/javascript">
    function add_decoration(){
      if($("#decoration_name").val()){
        $.ajax({ 
          method:'POST',
          url:'/decorations/add_decoration',
          data:{
