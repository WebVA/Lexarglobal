        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Edit Brands</h6>
                    ...
                    <div class="row">
                        <div class="col-md-3" style="display:none;">
                            <div class="form-group">
                                <label class="form-control-label" for="bland_id">Brand Id</label>
                                <input type="text" class="form-control" id="brand_id" name="brand_id" readonly placeholder="Can't input id" value="{{$result[0]->id}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-control-label" for="bland_name">Brand Name</label>
                                <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Enter Bland Name" value="{{$result[0]->brand_name}}">
                            </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="form-control-label" for="">Description</label>
                                <div data-toggle="quill" data-quill-placeholder="" id="brand_description_div"><?php echo $result[0]->description ?></div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div id="uploaded_image">
                                <img src="{{asset('public/upload/brand_images/'.$result[0]->brand_image)}}" class="img-thumbnail" width="300"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                        <button type="submit" class="btn btn-default" style="float:right;">Update Brand</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You updated a Brand!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to update a Brand!</span>
