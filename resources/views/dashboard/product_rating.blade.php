        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Product Rating List</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links">
                  <li class="breadcrumb-item"><a href="/dashboard"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item">Report</li>
                  <li class="breadcrumb-item active" aria-current="page">Product Rating List</li>
                </ol>
              </nav>
            </div>
          </div>
    ...
    <div class="margin-row">
        <div class="card">
          ...
          <div class="row">
              ...
              <div class="col-3">
                  <br>
                  <button class="btn btn-default" onclick="see_product()">See Products</a>
              </div>
          </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="custom-toggle">
                                <input type="checkbox" id="state_{{$temp['id']}}" <?php echo $temp['state']?'checked':''?> value="<?php echo $temp['state']?1:0?>" onchange="change_state($(this),{{$temp['id']}})">
                                <span for="state_{{$temp['id']}}" class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                            </label>
                        </td>
                        <td>{{$temp['created']}}</td>
                        <!-- <td class="text-right">
...
<script>
    function change_state(obj,id){
        ...
        $.ajax({
            method:'POST',
            url:'/report/change_rating_state',
            data:{
                id:id,
                state:obj.val(),
                "_token":"{{csrf_token()}}"
