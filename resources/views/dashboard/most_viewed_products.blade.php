        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Popular Products List</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links">
                  <li class="breadcrumb-item"><a href="/dashboard"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item">Products</li>
                  <li class="breadcrumb-item active" aria-current="page">Popular Products List</li>
                </ol>
              </nav>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="row">
              ...
              <div class="col-3">
                  <br>
                  <button class="btn btn-default" onclick="see_products()">See Products</button>
              </div>
          </div>
        </div>
        <div class="card_body">
...
<script>
  ...
  function see_products(){
    ...
    window.location.href = "/report/most_viewed_products/"+main_category+"/"+sub_category+"/"+brand+"/"+state+"/"+start_date+"/"+end_date;
  }
</script>
@endsection