        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Customers List</h6>
    ...
    <div class="margin-row">
        <div class="card">
            ...
            <div class="card-header flex">
                ...
                <a class="btn btn-default" href="/customers/add_customer">Add Customer</a>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="display:flex;align-items: center;height: 80px;">
                            <a href="{{ url('customers/edit_customer/' . $temp->id) }}/" class="table-action" data-toggle="tooltip" data-original-title="Edit customer">
                                <i class="fas fa-user-edit"></i>
                            </a>
                            <a href="javascript:void(0)" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="Delete customer" onclick="del_customer({{$temp->id}})">
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You deleted a customer!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to delete a customer!</span>
...
<script type="text/javascript">
    ...
    function export_excel(){
      window.location.href = '/customers/export-file';
    }
    ...
    var oTable = $('#datatable-buttons1').DataTable({
      retrieve: false,
      paging: false,
      searching: false,
      "order": [[ 2, "desc" ]]
