        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Edit Testimonials</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links">
                  <li class="breadcrumb-item"><a href="/dashboard"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="/websetting/testimonials_setting">Testimonials</a></li>
                  <li class="breadcrumb-item"><a href="/websetting/testimonials_setting">Manage Testimonials</a></li>
        ...
        <div class="card">
            ...
            <div class="card-header flex">
                <div class="row align-items-center" style="width: -webkit-fill-available;">
                    ...
                    <a href="/websetting/testimonials_setting" class="btn btn-sm btn-default">Back to List</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3" style="display:none">
                        <div class="form-group">
                            <label class="form-control-label" for="Product_name">testimonials Id</label>
                            <div class="input-group input-group-merge">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                            </div>
                            <input class="form-control" placeholder="Your name" type="text" id="id" value="{{$testimonials->id}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="title" value="{{$testimonials->title}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" id="description" rows="5">{{$testimonials->description}}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                    <button type="button" class="btn btn-default" style="float:right;" onclick="edit_testimonials()">Update Testimonials</button>
                    </div>
                </div>
            </div>
        </div>
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You edited a new testimonials!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to edit a new testimonials!</span>
    ...
    <script type="text/javascript">
        function edit_testimonials(){
            if($("#title").val() && $("#description").val()){
                $.ajax({ 
                    method:'POST',
                    url:'/websetting/edit_testimonials',
                    data:{
                        id:$("#id").val(),
                        title:$("#title").val(),
                        status:$("#status").val(),
