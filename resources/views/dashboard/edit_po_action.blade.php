        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Edit PO Action</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links">
                  <li class="breadcrumb-item"><a href="/dashboard"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="/po_actions/po_actions">Manage PO Action</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Edit PO Action</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div class="card">
            ...
            <div class="card-header flex">
                <div class="row align-items-center" style="width: -webkit-fill-available;">
                    <div class="col">
                        <h3 class="mb-0">PO Action Details</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="po_action_id" readonly value="{{$result[0]->id}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-control-label" for="po_action_name">PO Action Name</label>
                            <input type="text" class="form-control" id="po_action_name" placeholder="Enter po_action Name" value="{{$result[0]->action_name}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form>
                          <div class="form-group">
                            <textarea class="form-control" id="po_action_description" rows="3">{{$result[0]->description}}</textarea>
                          </div>
                        </form>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                    <button type="button" class="btn btn-default" style="float:right;" onclick="edit_po_action()">Save PO Action</button>
                    </div>
                </div>
            </div>
        </div>
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You updated a po_action!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to update a po_action!</span>
...
@section('script')
  <script type="text/javascript">
    function edit_po_action(){
      if($("#po_action_name").val()){
        $.ajax({ 
          method:'POST',
          url:'/po_actions/edit_po_action',
          data:{
            id:$("#po_action_id").val(),
