        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Edit Announcements</h6>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3" style="display:none">
                        <div class="form-group">
                            <label class="form-control-label" for="Product_name">announcements Id</label>
                            <div class="input-group input-group-merge">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                            </div>
                            <input class="form-control" placeholder="Your name" type="text" id="id" value="{{$announcements->id}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="title" value="{{$announcements->title}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" id="description" rows="5">{{$announcements->description}}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                    <button type="button" class="btn btn-default" style="float:right;" onclick="edit_announcements()">Update Announcements</button>
                    </div>
                </div>
            </div>
        </div>
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You edited a new announcements!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to edit a new announcements!</span>
    ...
    <script type="text/javascript">
        function edit_announcements(){
            if($("#title").val() && $("#description").val()){
                $.ajax({ 
                    method:'POST',
                    url:'/websetting/edit_announcements',
                    data:{
                        id:$("#id").val(),
                        title:$("#title").val(),
                        status:$("#status").val(),
