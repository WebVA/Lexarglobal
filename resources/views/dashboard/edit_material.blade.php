        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Edit Material</h6>
    ...
    <div class="margin-row">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="material_id" readonly value="{{$result[0]->id}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-control-label" for="material_name">material Name</label>
                            <input type="text" class="form-control" id="material_name" placeholder="Enter material Name" value="{{$result[0]->name}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form>
                          <div class="form-group">
                            <textarea class="form-control" id="material_description" rows="3">{{$result[0]->description}}</textarea>
                          </div>
                        </form>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                    <button type="button" class="btn btn-default" style="float:right;" onclick="edit_material()">Save material</button>
                    </div>
                </div>
            </div>
        </div>
...
<div id="success_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-primary fade show" role="alert">
  ...
  <span class="alert-text"><strong>Success!</strong> You updated a material!</span>
...
<div id="fail_notify" style="display:none;position:absolute;right:30px;top:70px;" class="alert alert-danger alert-dismissible fade show" role="alert">
  <span class="alert-icon"><i class="ni ni-like-2"></i></span>
  <span class="alert-text"><strong>Fail!</strong> You failed to update a material!</span>
